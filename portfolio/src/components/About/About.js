        ...
        <div className="about-sub-page">
          ...
          <div className="about-page-container">
            <div className="about-content">
              ...
              {/* About Me Section */}
              <div className="scroll-section" id='AboutMe'>
                <motion.div 
                ...
                >
                  <div className="about-container">
                    <div className="about-info">
                      <img src={gradpic} alt="Alexander Isaac P. Platon"/>
              ...
              {/* Skills Section */}
              <div className="skills-container scroll-section" id='Skills'>
                <motion.div
              ...
              <div className="about-certification scroll-section" id='Certifications'>
                <motion.div
                      ...
                      <React.Fragment key={index}>
                        <div className="cert-icons">
                          ...
                          <div className="cert-details">
                            ...
                            <a href={cert.url} target="_blank" rel="noopener noreferrer" className="cert-button">
